...
def main():
    ...
    test_account = connect(args['<user-name>'], args['<user-pass>'], args['<exch-server>'])

    if args['--inbox']:
        processing_folder = test_account.inbox
    else:
        processing_folder = test_account.inbox / args['--inbox-subdir']
